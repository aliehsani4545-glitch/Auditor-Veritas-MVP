...
// --- VISUAL COMPONENTS (Exact copy from Dashboard.jsx) ---
...
// 2. Narrator (The Guide)
const Narrator = ({ text, step, total }) => (
  <motion.div 
    initial={{ y: 50, opacity: 0 }} 
    animate={{ y: 0, opacity: 1 }} 
    exit={{ y: 50, opacity: 0 }}
    className="fixed bottom-6 left-4 right-4 md:left-1/2 md:-translate-x-1/2 z-[60] bg-slate-900/95 backdrop-blur-md text-white p-5 rounded-xl shadow-2xl flex items-start md:items-center gap-5 border border-slate-700 max-w-2xl w-auto mx-auto"
  >
...
const DashboardPreview = () => {
  ...
  // --- VIEW 1: LOGIN (Dark Mode) ---
  if (view === 'login') {
    return (
      <div className="min-h-screen bg-[#020617] text-slate-200 font-sans relative flex flex-col">
        <Narrator text={narrator.text} step={narrator.step} total={5} />
  ...
  if (view === 'setup') {
    return (
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 font-sans text-slate-900">
             <Narrator text={narrator.text} step={narrator.step} total={5} />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
                ...
                {/* 2. MERKLE PROOF (MATCH SCREENSHOT 1) */}
                {activeTab === 'merkle' && (
                ...
                {/* 3. GDPR ERASURE (MATCH SCREENSHOT 2) */}
                {activeTab === 'gdpr' && (
