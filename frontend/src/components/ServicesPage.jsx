...
const ServicesPage = ({ setActiveTab }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] pt-32 pb-20 px-4 md:px-8 relative overflow-hidden">
      ...
      {/* Custom Styles for the 'Flash' Animation */}
      <style>{`
      ...
      {/* --- FLUID DIAGONAL WAVE BACKGROUND (Matching the image style) --- */}
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        
        {/* The Main Diagonal Beam (Purple -> Cyan Gradient) */}
        <motion.div
        ...
        {/* Secondary Beam for Depth (Bottom) */}
        <motion.div
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, i) => (
                ...
                >
                    ...
                    <button 
                        onClick={() => setActiveTab(service.target)}
