...
// --- LIVING HERO SCENE (New Interactive Design) ---

const LivingHeroScene = () => (

    <div className="absolute inset-0 overflow-hidden pointer-events-none">

        {/* Stor pulserande blå sfär */}
...
function App() {
    ...
    const [chartData, setChartData] = useState([]); // Tom array för att vänta på riktig data
    ...
    const fetchDashboard = useCallback(async () => {
        ...
        try {
            ...
            // --- FIX: Raderar mock-logiken. ChartData förblir tom [] tills du skapar en time-series endpoint.
            ...
            // FIX: Fånga 404-felet eller det specifika meddelandet för att visa Create UI
    ...
    // Simple event injector for the dashboard (Använder riktig API-nyckel/endpoint)
    ...
    const handleLogEvent = async (e, eventData) => {
        ...
        try {
            ...
            if (!processor || !processor.api_key_raw) throw new Error("Processor key not available."); // Extra check
            ...
            await apiCall('/api/events', { 
                ...
                body: { 
                    ...
                    user_identifier: eventData.user_identifier || 'demo-user-api-test' // Säkerställer att identifierare finns
                ...
                {activeTab === 'home' && (
                    ...
                    <div className="bg-[#020617] min-h-screen">
                        ...
                        <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden text-center z-10 pt-20">
                            ...
                            {/* NY: Levande Interaktiv Bakgrund */}
