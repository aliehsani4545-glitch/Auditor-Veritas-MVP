...
const HowItWorks = ({ setActiveTab }) => {
  ...
  const simulateApiCall = () => {
    ...
    const executeStep = () => {
      if (currentStep < steps.length) {
        setTerminalOutput({ type: 'process', text: steps[currentStep].text });
        currentStep++;
  ...
  const simulateTamper = () => {
    ...
    // Phase 1: Show tampering on middle block
    setTimeout(() => {
    ...
    // Phase 2: Spread to other blocks
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-cyan-50/20">
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(600px at ${mousePosition.x}px ${mousePosition.y}px, rgba(99, 102, 241, 0.1) 0%, transparent 80%)`
        }}
      />
  ...
  <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 px-4 sm:px-0 py-12">
    ...
    <div className="text-center pt-8">
      <button 
        ...
        className="text-blue-600 font-semibold hover:text-blue-700 transition flex items-center justify-center mx-auto text-lg"
      >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-cyan-50/20 font-sans flex flex-col">
      ...
      <main className="flex-1">
        ...
        {activeTab === 'events' && (
          <div className="max-w-xl mx-auto bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20 my-8 animate-in">
            <div className="flex items-center mb-8 pb-6 border-b border-slate-200">
              <div className="p-3 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl mr-4">
                <FileText className="w-8 h-8 text-blue-600"/> 
              </div>
              <div>
                <h2 className="text-3xl font-bold text-slate-900">Log New Event</h2>
                <p className="text-slate-600 mt-1">Manually record an audit event in your secure trail</p>
              </div>
            </div>
            ...
            <form onSubmit={logEvent} className="space-y-6">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full p-4 border border-slate-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition bg-white hover:border-slate-400" 
                  placeholder="e.g. user_login, data_access, file_download" 
                  value={eventData.event_type} 
                  onChange={e => setEventData({...eventData, event_type: e.target.value})} 
                  required 
                />
                <p className="text-sm text-slate-500 mt-2">Enter a descriptive event type for easy categorization</p>
              </div>
              ...
              <div>
                ...
                <textarea 
                  className="w-full p-4 border border-slate-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none font-mono text-sm h-40 bg-white hover:border-slate-400 resize-vertical" 
                  ...
                  required 
                />
                <p className="text-sm text-slate-500 mt-2">Enter valid JSON with additional event details and metadata</p>
              </div>
              
              <button 
                type="submit" 
                disabled={isLoading} 
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-2xl font-bold text-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? (
                  <span className="flex items-center justify-center">
                    <RefreshCw className="w-5 h-5 mr-3 animate-spin" />
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl border border-slate-200">
              ...
              <ul className="text-slate-600 space-y-2">
                <li className="flex items-center">
                  ...
                  Event is encrypted and added to the immutable audit trail
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
                  Hash chain is updated to maintain data integrity
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
                  Real-time dashboard statistics are refreshed
                </li>
              </ul>
            </div>
          </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 mt-20 border-t border-slate-800">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-base mb-8 max-w-md mx-auto leading-relaxed text-slate-500">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-8 text-base font-medium mb-8">
          ...
          <p className="text-sm text-slate-600">&copy; 2025 Auditor Veritas. All rights reserved.</p>
        </div>
      </footer>
      ...
      {showCookieBanner && (
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center transform transition-all scale-100 border border-white/20 mx-4">
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <ShieldCheck className="w-8 h-8 text-blue-600" />
            </div>
            
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Privacy & Security</h3>
            
            <p className="text-slate-600 mb-8 leading-relaxed">
              To ensure GDPR compliance and security, we need your consent to store essential session tokens. 
              <strong className="text-slate-800"> No tracking cookies</strong> or third-party analytics are used.
              <br /><br />
            ...
            <div className="space-y-4">
              <button 
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-4 rounded-2xl font-bold hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Accept & Continue
              </button>
              ...
              <button 
                ...
                className="text-blue-600 hover:text-blue-700 font-medium underline decoration-blue-300 underline-offset-4 hover:decoration-blue-600 transition"
              >
